 ...
 * @author guilherme
 */
public class CategoriaResourceNGTest {
    ...
    public void testCreate() throws  IOException, JSONException, URISyntaxException, HttpException {
        ...
        HttpPost post = new HttpPost("http://localhost:8082/categorias");
        //StringEntity input = new StringEntity("product");
        JSONObject json = new JSONObject();
        json.put("nome", "categoria 1 ");
    ...
    public void testRead() throws IOException, URISyntaxException, HttpException {
        ...
        System.out.println("Lendo categorias ...");
        ...
        HttpClient client = new DefaultHttpClient();
        HttpGet request = new HttpGet("http://localhost:8082/categorias");
